  ...
  columns <- lapply(selected_order, function(order) {
    ...
    ## EBM
      ...
      div(style = "flex: 1;margin-right: 20px;",
             ...
             selectInput("max_clamp", "Clamp", choices = c("No" = FALSE, "Yes" = TRUE),
                         selected = FALSE),
