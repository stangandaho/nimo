...
#'
#' @description The function was initially designed by Velazco et al. (2022).
...
#' modelling workflow. Methods in Ecology and Evolution, 13(8), 1661–1669.
#' [{https://doi.org/10.1111/2041-210X.13874}](https://doi.org/10.1111/2041-210X.13874)
#' @export

nm_predict <- function(models,
           pred,
           nchunk = 1,
           thr = NULL,
           con_thr = FALSE,
    ...
    df <- data.frame(
      ...
      names = c("gam", "gau", "glm", "gbm", "max", "net", "raf", "svm", "bioc")
    )
